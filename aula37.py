...
print('A letra que apareceu mais vezes foi "{}".'.format(letra_que_apareceu_mais_vezes))
print('"{}" foi a quantidade de vezes que apareceu.'.format(qtd_apareceu_mais_vezes))
